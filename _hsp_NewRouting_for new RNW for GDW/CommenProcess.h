...
typedef struct SystemParameter
{
	...
	int RegionSystem;   //Regionindex的位数, shy, 20130904
	int CompRegion;      //20140514,shy
	int CompValue;      //20140514,shy
	int CompLength;     //20140514,shy
...
public:
	...
	SystemParameter SParameter;//HydroUsePara表变量, 20130904,shy
